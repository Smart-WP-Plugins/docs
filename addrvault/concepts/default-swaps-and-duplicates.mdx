...
description: "Why reassigning a default never loses data, and how Unwan recognizes the same address twice"
icon: "shuffle"
---
...
<Steps>
  ...
  <Step title="The displaced address is checked">
    Unwan reads what _used_ to be in that profile field, before the overwrite.
  </Step>
...
2. Unwan notices _123 Main St_ used to be there and doesn't match _456 Oak Ave_.
