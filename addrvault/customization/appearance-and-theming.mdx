...
<Note>
  If you're overriding the accent color yourself via the `unwan_accent_color` filter or custom CSS, keep the hex and RGB-channel values in sync — see [CSS Variables & Markup](/addrvault/customization/css-and-markup) for the underlying tokens.
</Note>
