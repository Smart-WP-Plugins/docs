...
<AccordionGroup>
  ...
  <Accordion title="What languages is Unwan available in?">
    Unwan ships with translations for ten languages: Spanish, French, German, Italian, Portuguese (Brazil), Dutch, Polish, Russian, Swedish, and Japanese. They cover both the customer-facing screens and the settings page, and apply automatically once WordPress is running in that language — nothing to install or configure.

    Any label you edit under **Text and labels** takes priority over the translation for that string, so a customized label stays exactly as you typed it. If a community translation for your locale is published on translate.wordpress.org, WordPress uses that in preference to the bundled copy.
  </Accordion>
