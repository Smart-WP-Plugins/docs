...
- No style mutation from JavaScript — all presentation lives in `assets/css/unwan.css`, documented on the [CSS Variables & Markup](/addrvault/customization/css-and-markup) page.
