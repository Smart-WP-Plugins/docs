...
| WordPress | 6.5 | 7.1 |
| PHP | 7.4 | 8.3 |
| WooCommerce | 8.2 | 11.0.1 |

"Verified against" is the newest version Unwan's [test suite](/unwan/developers/architecture#testing) has been run green on, not a ceiling — newer releases are expected to work and are checked each time Unwan itself is updated.
...
<Steps>
  ...
  <Step title="Install Unwan">
    Either search for **Unwan – Multiple Address Book for WooCommerce** under **Plugins → Add New Plugin** in your WordPress admin, or upload `unwan-for-woocommerce.zip` directly via **Plugins → Add New Plugin → Upload Plugin**.
  </Step>
