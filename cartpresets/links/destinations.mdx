...
Each preset can choose its own destination under **After the items are added, send the customer to**, or **Use the Settings default**. The editor shows what the store setting currently is, so you can see what "follow the store setting" means without leaving the page.
