...
description: "All nineteen customer-facing strings, their defaults, and how to translate them"
icon: "comment"
---
...
Every sentence and label a customer reads is editable, under **Settings → Cart notices and labels → Edit wording**. There are nineteen, in four groups.
...
| `item_blocked` | An item failed and **If an item cannot be added** is set to refuse the whole preset | This preset is unavailable because one of its items cannot be purchased right now. |
