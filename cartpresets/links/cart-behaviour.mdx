...
A customer following your link often already has a cart. Three switches decide what happens to it, under **Settings → Cart behaviour**.

<Media>The Cart behaviour section with all three switches, the lower two disabled because the first is on</Media>
...
The editor asks the same three questions again, for one preset, under **The cart this link finds**.
