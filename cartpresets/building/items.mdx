...
Products go out of stock, get deleted, or are limited to one per order. What the link does then is a store-wide setting under **Settings → Cart behaviour → If an item cannot be added**:
