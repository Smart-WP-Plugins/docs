...
One row holds it: a redemption, written when a customer claims a preset that carries a purchase limit. A signed-in customer is recorded as their account, a guest by their billing email — the only way to recognise the same guest twice.
