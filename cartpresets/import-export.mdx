...
**All of them** — **Settings → Data control → Preset data → Export presets**. One file holds up to 200 presets.
...
On the destination store, go to **Settings → Data control → Preset data → Import presets** and choose the file. One import takes up to 500 presets; anything beyond that is reported as skipped rather than silently dropped.
